...
ajout = {"couriel": "2112344@cegepmontpetit.ca"}
etudiant.update(ajout)
print(f"Voici le courriel de l'étudiant qui a été ajouté: {etudiant["couriel"]}")
...
etudiant['couriel'] = "2000000@cegepmontpetit.ca"
print(f"Voici le nouveau courriel de l'étudiant: {etudiant["couriel"]}")
...
#      Dans le terminal on veut: Q6: Voici le nouveau courriel de l'étudiant: 17
age_etudiant = etudiant.pop("age")
print(f"Voici le nouveau courriel de l'étudiant: {age_etudiant}")
